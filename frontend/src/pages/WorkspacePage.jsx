...
export default function WorkspacePage() {
  ...
  return (
    <>
      {/* Extra styling sirf Parent select ke liye */}
      <style>{`
        .wp-sx-select {
          max-height: 44px;
          padding-right: 32px;
      ...
      <div className="container mt-4 workspace-shell">
        ...
        <div className="row workspace-main-row">
          <div className="col-md-4 workspace-left">
          ...
          <div className="col-md-8 workspace-right">
            <div className="card p-3 mb-3">
              ...
              <div className="wp-sx-modal-card" role="document">
                ...
                >
                  ...
                  <div className="wp-sx-field">
                    ...
                    <select
                      id="wp-sx-parent"
                      className="wp-sx-input wp-sx-select"
                      value={parent}
  ...
  return (
    <form onSubmit={add} className="mt-2">
      <div className="mb-2">
        ...
        <small style={{ color: "#90a0b6", fontSize: 15 }}>
          Existing users will be added directly. No email is sent.
        </small>
      </div>
